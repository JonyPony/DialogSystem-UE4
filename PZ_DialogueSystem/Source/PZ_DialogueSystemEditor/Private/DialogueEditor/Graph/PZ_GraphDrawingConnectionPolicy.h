...
class FPZ_GraphDrawingConnectionPolicy : public FConnectionDrawingPolicy
{
...
public:
	...
	FPZ_GraphDrawingConnectionPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph* InGraphObj);
