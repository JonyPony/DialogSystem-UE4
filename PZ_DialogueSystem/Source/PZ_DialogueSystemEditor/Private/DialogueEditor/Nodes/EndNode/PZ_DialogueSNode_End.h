...
class UPZ_DialogueEdNode_End;
class UPZ_DialogueREndNode;



class SPZ_DialogueSNode_End : public SPZ_DialogueSNode_Base
{

	typedef SPZ_DialogueSNode_Base Super;
	typedef SPZ_DialogueSNode_End Self;


public:

	SLATE_BEGIN_ARGS(SPZ_DialogueSNode_End) {}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs, UPZ_DialogueEdNode_End* InNode);
...
public:
	...
	UPZ_DialogueEdNode_End* EdEndNode = nullptr;
	UPZ_DialogueREndNode* REndNode = nullptr;
